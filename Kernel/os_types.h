...
/* TYPES */
...
#if defined(CPU_SIZEOF_VOID_P)
    #if (CPU_SIZEOF_VOID_P==1)
        typedef int8_t          os_int_t;
        typedef uint8_t         os_uint_t;
        typedef uint8_t         os_size_t;
        typedef int8_t          os_intptr_t;
        typedef uint8_t         os_uintptr_t;
        ...
        typedef  int16_t         os_intptr_t;
        typedef uint16_t         os_uintptr_t;
